define('tools/pkView/components/report/newReport/newvariabilityReport', [
    'knockout',
    'durandal/app',
    'plugins/dialog',
    'ocpkmlib/net',
    ...
    var ctor = function () {
        ...
        self.createNew = function () {
            ...
            var references = $.map(study.Cohorts(), function (cohort, i) {
                return { Cohort: cohort.Name, Reference: ko.observable(ko.unwrap(cohort.Reference)) ,MetaCohorts:null, Doses:null};
            });
