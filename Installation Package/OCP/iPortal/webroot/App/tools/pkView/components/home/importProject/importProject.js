define('tools/pkview/components/home/importProject/importProject', [
    'knockout',
    'durandal/app',
    'plugins/dialog',
    'ocpkmlib/net',
...
function (ko, app, dialog, net, txt) {
    var ctor = function () {
        ...
        self.getUserProjects = function (submission) {
            ...
            self.waitingForData(true);
            $.get('/api/pkview/listsubmissionprojects?submission=' + submission)
    ...
    ctor.prototype.activate = function (settings) {
        var self = this;
        self.subscriptions = [];
        self.subscriptions.push(self.selectedSubmission.subscribe(self.getUserProjects));
        self.subscriptions.push(self.selectedUser.subscribe(self.updateProjectList));
