define('tools/pkView/components/review/sections/studyMeta', [
    'knockout'],
function (ko) {
    ...
    ctor.prototype.activate = function (settings) {
        ...
        for (i = 0; i < self.validStudies().length;i++)
        {
            for (j = 0; j < self.validStudies()[i].Reports.length; j++)
            {
                ...
                if (self.validStudies()[i].Reports[j].Type == 5)
        ...
        self.reportSettingsView = ko.computed(function () {
            ...
            var model = "tools/pkView/components/report/reportSettings/types/forestplot/forestplotMeta";
