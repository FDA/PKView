define('tools/pkView/components/report/reportSettings/reportSettings',
    ['knockout'],
function (ko) {
    ...
    ctor.prototype.activate = function (settings) {
        ...
        self.reportSettingsView = ko.computed(function () {
            ...
            switch (currentReport.Type) {
                case 1:
                    model = 'tools/pkView/components/report/reportSettings/types/pkSummaryTable/pkSummaryTable'; break;
                case 2:
                    model = 'tools/pkView/components/report/reportSettings/types/forestplot/forestplot'; break;
                case 3:
                    model = 'tools/pkView/components/report/reportSettings/types/ncaAnalysis/ncaAnalysis'; break;
                case 4:
                    model = 'tools/pkView/components/report/reportSettings/types/concentration/concentration'; break;                
            }
