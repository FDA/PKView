...
!function (window) {
    ...
    intellisense.annotate(window, {
        define: function () {
            ...
            /// </signature>
            /// <signature>
            ///     <summary>Defines an anonymous module, with optional dependencies, whose value is determined by executing a callback.</summary>
            ///     <param name="deps" type="Array" elementType="String" optional="true">An array of modules that this module depends on</param>
            ///     <param name="callback" type="Function">The callback that will be called when your module is asked to produce a value</param>
            /// </signature>
            /// <signature>
    ...
    requirejs.load = function (context, moduleName, url) {
        moduleUrls.push(url);
        intellisense.logMessage('loading module ' + url);
        oldLoad.call(requirejs, context, moduleName, url);
    }

    window.define = function (name, deps, callback) {

        // Support for anonymous modules
        //if (typeof(name) !== 'string')
        //{
        //    //try { throw Error('foobar'); intellisense.logMessage('after error'); } catch (err) { intellisense.logMessage('catch'); }
        //    //intellisense.logMessage('property: ' + (new Error).stack);
        //    var scripts = document.getElementsByTagName("script");
        //    intellisense.logMessage('#' + scripts.length);
        //    //for (var i = 0; i < scripts.length; i++)
        //    //    for(var prop in scripts[0])
        //    //        intellisense.logMessage('property: ' + prop + ' : ' + scripts[0][prop]);
        //    xmlhttp = new ActiveXObject("Microsoft.XMLHTTP");
        //    xmlhttp.open("GET", '/Scripts/ocpkmlib/net.js', true);
        //    xmlhttp.onreadystatechange = function () {
        //        intellisense.logMessage('' + xmlhttp.readyState);
        //        var fileContent = xmlhttp.responseText;
        //        intellisense.logMessage('' + fileContent);
        //    };
        //    xmlhttp.send(null);
        ...
        //    //    intellisense.logMessage('PROPERTY ' + property + ' :: ' + inspect[property]);
